...
export default function SortChip() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((o) => !o)}
        className="inline-flex items-center gap-1 rounded-md border border-gray-300 bg-white px-2.5 py-1 text-sm text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        <span>{arrow}</span>
      ...
      {open && (
        <div className="absolute left-0 z-50 mt-1 w-56 rounded-lg border border-gray-200 bg-white p-3 shadow-lg">
