...
export const FIELD_DEFS: FieldDef[] = [
  ...
  { key: "max_heart_rate", label: "Max Heart Rate", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
  { key: "hr_zone1_pct", label: "HR Zone 1 %", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
  { key: "hr_zone2_pct", label: "HR Zone 2 %", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
  { key: "hr_zone3_pct", label: "HR Zone 3 %", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
  { key: "hr_zone4_pct", label: "HR Zone 4 %", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
  { key: "hr_zone5_pct", label: "HR Zone 5 %", type: "number", operators: NUMBER_OPS, filterable: true, sortable: true, requiresDetail: true },
